import Box from "./Box";
import { UserPlus, FileEdit, Bell } from "lucide-react";

export default function HowWorks() {
  return (
    <section
      id="howworks"
      className="py-16 px-6 md:px-16 lg:px-24 bg-[#F2D9B6]"
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        />
        <Box
          title="3 - Fique de olho em sua conta"
          description="Quando alguém encontrar um pet semelhante ao que você cadastrou ou quiser entrar em contato sobre um animal encontrado, você receberá uma notificação em tempo real em sua conta no site. Fique atento para não perder nenhuma atualização!"
          icon={Bell}
        />
      </div>
    </section>
